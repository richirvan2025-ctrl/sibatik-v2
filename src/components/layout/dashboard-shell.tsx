    ...
    <>
      ...
      <div className="sibatik-shell-enter flex h-[100dvh] min-h-[100svh] bg-[var(--background)] text-[#101A36]">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sibatik-header-batik z-10 flex h-[calc(50px+env(safe-area-inset-top))] shrink-0 items-center justify-between bg-[var(--brand-header)] px-4 pt-[env(safe-area-inset-top)] text-white shadow-[0_5px_17px_rgba(0,25,43,0.30)] md:h-[50px] md:px-5 md:pt-0">
